...
/**
 * dist[] will finally contain the shortest distance of each node from the source
 *
 * */
public class DijkstrasPriorityQueue {
    ...
    public DijkstrasPriorityQueue(int V) {
        this.V = V;
        dist = new int[V];
        visited = new HashSet<Integer>();
        minHeap = new PriorityQueue<Node>(V, new Node());
    }
    ...
    public void algo_dijkstra(List<List<Node>> adj_list, int src_vertex) {
        ...
        minHeap.add(new Node(src_vertex, 0));
    ...
    public static void main(String arg[]) {
        ...
        DijkstrasPriorityQueue dpq = new DijkstrasPriorityQueue(V);
